...
public class conta5 extends ContaGeral {
	protected double saldo5;
	private double emprestimoEstudante = 5000;
	public conta5(String tipo, int numero) {
		super(emprestimoEstudante, emprestimoEstudante, emprestimoEstudante, numero, tipo, tipo, numero);
	}
